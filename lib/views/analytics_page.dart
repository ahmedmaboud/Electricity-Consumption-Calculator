...
class AnalyticsView extends StatelessWidget {
    ...
    return Obx(() {
      ...
      return Container(
        ...
        child: Row(
          children: [
            Expanded(
              child: _toggleItem(context, 'Monthly', isMonthly, () => ctrl.setMode(AnalyticsMode.monthly)),
            ),
            Expanded(
              child: _toggleItem(context, 'Yearly', !isMonthly, () => ctrl.setMode(AnalyticsMode.yearly)),
            ),
          ],
        ),
      );
  ...
  Widget _toggleItem(BuildContext context, String title, bool isActive, VoidCallback onTap) {
    final isDark = Theme.of(context).brightness == Brightness.dark;
                ...
                barGroups: List.generate(values.length, (i) {
                  ...
                  return BarChartGroupData(
                    ...
                    barRods: [
                      BarChartRodData(
                        toY: values[i],
                        color: isSelected ? getActiveColor(context) : getInactiveColor(context),
                        width: 16,
  ...
  Widget _buildCostBreakdownCard(BuildContext context, CostBreakdown breakdown, double totalCost) {
    ...
    final sections = [
      ...
      PieChartSectionData(color: offPeakColor, value: breakdown.offPeak, radius: 12, showTitle: false),
    ...
    final displaySections = isEmpty
        ? [PieChartSectionData(color: emptyColor!, value: 1, radius: 12, showTitle: false)]
        : sections;
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    _legendItem(context, activeColor, 'Peak Hours', breakdown.peak),
                    ...
                    const SizedBox(height: 12),
                    _legendItem(context, inactiveColor, 'Taxes & Fees', breakdown.taxes),
                  ],
                ),
              ),
            ],
  ...
  Widget _legendItem(BuildContext context, Color color, String label, double value) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        Row(
